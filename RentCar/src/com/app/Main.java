...
public class Main {
	public static void main(String[] args) {
		...
		System.out.println("Add car Uno: "+ store.AddCar( new Car("Uno com escada","VFB 1291" , "Branco gelo", sluxo, 1993)));
		System.out.println("Add car gol: "+store.AddCar( new Car("gol","VFB 1271" , "Branco gelo",sluxo, 1993)));
		// gerando pedidos
